...
df= pd.read_csv("Final Assement/Space_Industry_Analytics_2010_2024.csv")
...
plt.savefig("Final Assement/images/launches_vs_company.png", dpi=300, bbox_inches="tight")
plt.show()
plt.close()
...
plt.savefig("Final Assement/images/revenue_growth.png", dpi=300, bbox_inches="tight")
plt.show()
plt.close()
...
plt.savefig("Final Assement/images/success_rate.png", dpi=300, bbox_inches="tight")
plt.show()
plt.close()
...
plt.savefig("Final Assement/images/funding_vs_revenue.png", dpi=300, bbox_inches="tight")
plt.show()
plt.close()
...
plt.savefig("Final Assement/images/employees_vs_revenue.png", dpi=300, bbox_inches="tight")
plt.show()
plt.close()
#--------Launches vs Revenue----------
plt.figure(figsize=(8,5))
...
plt.savefig("Final Assement/images/launches_vs_revenue.png", dpi=300, bbox_inches="tight")
plt.show()
plt.close()
#--------Correlation Heatmap--------
plt.figure(figsize=(8,5))
sns.heatmap( df.corr(numeric_only=True),
            annot=True,
            cmap="coolwarm")
plt.savefig("Final Assement/images/correlation_heatmap.png", dpi=300, bbox_inches="tight")
plt.show()
plt.close()
#---------MACHINE LEARNING---------
...
plt.savefig("Final Assement/images/actual_vs_predicted.png",dpi=300,bbox_inches="tight")
